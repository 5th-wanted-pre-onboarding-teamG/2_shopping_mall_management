...
export class PaymentsRepository extends Repository<Payments> {
   ...
   * @param orderId 주문 Id
   */
  async getOrderById(entityManager: EntityManager, orderId: number): Promise<Orders> {
   ...
   */
  async getOwnedCouponById(entityManager: EntityManager, ownedCouponId: number): Promise<OwnedCoupons> {
